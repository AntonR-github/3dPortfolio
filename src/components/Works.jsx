  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          Following projects showcases my skills and experience through real-world examples of my work. <br />
          Each project is briefly described with links to code repositories and live demos in it. <br />
          It reflects my ability to solve complex problems, work with different technologies, <br />
